...
module CryptCheck
  module Ssh
    class Server < CryptCheck::Server
      include Ssh::Grade
      ...
      HMAC = {
        ...
        'hmac-sha2-512'                 => nil,
        'hmac-sha2-256'                 => nil,
        'hmac-sha1-etm@openssh.com'     => :red, # SHA-1
        'hmac-sha1' => :red, # SHA-1
        'hmac-sha1-96-etm@openssh.com' => :red, # EXPORT + SHA-1
        'hmac-sha1-96' => :red, # EXPORT + SHA-1
        'hmac-ripemd160-etm@openssh.com' => :green,
        'hmac-ripemd160'                 => nil,
        'hmac-md5-etm@openssh.com'       => :red, # MD5
        'hmac-md5' => :red, # MD5
        'hmac-md5-96-etm@openssh.com' => :red, # EXPORT + MD5
        'hmac-md5-96' => :red, # EXPORT + MD5
      ...
      def initialize(hostname, ip, _, port = 22)
        ...
        @kex, @encryption, @hmac, @compression, @key = kex[:kex], kex[:encryption],
          kex[:mac], kex[:compression], kex[:host_key]
